...
<div id="orderBill_datagrid_btn">
    <div>
        ...
        <c:if test="${myFn:checkPermission('cn.xy.crm.web.controller.OrderBillController:checked')}">
            <a class="easyui-linkbutton" iconCls="icon-tip" plain="true" data-cmd="checked">审核</a>
        </c:if>
        <c:if test="${myFn:checkPermission('cn.xy.crm.web.controller.OrderBillController:departmentChecked')}">
            <a class="easyui-linkbutton" iconCls="icon-cog" plain="true" data-cmd="checked">部门审核</a>
        </c:if>
        <c:if test="${myFn:checkPermission('cn.xy.crm.web.controller.OrderBillController:financeChecked')}">
