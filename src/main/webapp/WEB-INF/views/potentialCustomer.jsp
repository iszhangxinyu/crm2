...
<div id="potentialCustomer_datagrid_btn">
    <div>
        <c:if test="${myfn:checkPermission('cn.xy.crm.web.controller.PotentialCustomerController:save')}">
            <a class="easyui-linkbutton" iconCls="icon-add" plain="true" data-cmd="add">新增</a>
        </c:if>
        <c:if test="${myfn:checkPermission('cn.xy.crm.web.controller.PotentialCustomerController:update')}">
            <a class="easyui-linkbutton" iconCls="icon-edit" plain="true" data-cmd="edit">编辑</a>
        </c:if>
        <c:if test="${myfn:checkPermission('cn.xy.crm.web.controller.PotentialCustomerController:updateInCharge')}">
            <a class="easyui-linkbutton" iconCls="icon-tip" plain="true" data-cmd="share">共享</a>
        </c:if>
        <c:if test="${myfn:checkPermission('cn.xy.crm.web.controller.PotentialCustomerController:ALL')}">
            <a class="easyui-linkbutton" iconCls="icon-tip" plain="true" data-cmd="turnOver">移交</a>
        </c:if>
        <c:if test="${myfn:checkPermission('cn.xy.crm.web.controller.PotentialCustomerController:developFailed')}">
            <a class="easyui-linkbutton" iconCls="icon-no" plain="true" data-cmd="developFalse">开发失败</a>
        </c:if>
        <c:if test="${myfn:checkPermission('cn.xy.crm.web.controller.PotentialCustomerController:become')}">
