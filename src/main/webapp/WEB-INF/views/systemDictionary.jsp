...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/views/systemDictionary.js"></script>
</head>
<body>
<div class="easyui-layout" data-options="fit:true" style="width: 700px; height: 350px;">
    ...
    <div data-options="region:'center',title:'字典目录明细',iconCls:'icon-ok'">
        ...
        <div id="systemDictionaryItem_tb">
            <c:if test="${myfn:checkPermission('cn.xy.crm.web.controller.SystemDictionaryItemController:save)')}">
                <a class="easyui-linkbutton" iconCls="icon-add" plain="true" data-cmd="add">新增</a>
            </c:if>
            <c:if test="${myfn:checkPermission('cn.xy.crm.web.controller.SystemDictionaryItemController:update)')}">
                <a class="easyui-linkbutton" iconCls="icon-edit" plain="true" data-cmd="edit">编辑</a>
            </c:if>
            <c:if test="${myfn:checkPermission('cn.xy.crm.web.controller.SystemDictionaryItemController.forbidden')}">
                ...
                <table align="center" style="margin-top: 15px;">
                    ...
                    <tr>
                        ...
                        <td><input class="easyui-combobox" name="parent.id"
                                   data-options="valueField:'id',textField:'name',url:'/sysDic_queryAllDic'"/></td>
                    </tr>
                    <tr>
                        <td>字典明细名称</td>
