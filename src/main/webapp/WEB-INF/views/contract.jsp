...
<div id="contract_datagrid_btn">
    <div>
        ...
        <c:if test="${myfn:checkPermission('cn.xy.crm.web.controller.ContractController:checked')}">
            <a class="easyui-linkbutton" iconCls="icon-tip" plain="true" data-cmd="checked">审核</a>
        </c:if>
        <c:if test="${myfn:checkPermission('cn.xy.crm.web.controller.ContractController:departmentChecked')}">
            <a class="easyui-linkbutton" iconCls="icon-cog" plain="true" data-cmd="checked">部门审核</a>
        </c:if>
        <c:if test="${myfn:checkPermission('cn.xy.crm.web.controller.ContractController:financeChecked')}">
